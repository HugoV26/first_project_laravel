...
<a class="btn btn-success btn-sm mt-3 mb-3" href="{{ route('user.create')}}">
    Create
</a>
    <table class="table">
        <thead>
        ...
        <tbody>
            @foreach ($users as $user)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('user.show', $user->id) }}" class="btn btn-primary">See</a>
...
<script>
    window.onload = function() {
        ...
        var modal = $(this)
        modal.find('.modal-title').text('You are going to delete the following user: ' + id)
      });
    };
